                                ...
                                <div class="p-6 "  >
                                        <div class="flex flex-wrap -mx-3 mb-6 ">
                                            ...
                                            <div class="w-full md:w-1/2 px-3">
                                              ...
                                              <input name="link[0][link]" class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"  type="text">
                                            </div>
                                        </div>
                                          <div class="flex flex-wrap -mx-3 mb-6">
                                ...
                                <div class="p-6 "  >
                                    <div class="flex flex-wrap -mx-3 mb-6 ">
                                        ...
                                        <div class="w-full md:w-1/2 px-3">
                                          ...
                                          <input name="link[${count}][link]" class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" type="text" >
                                        </div>
                                    </div>
                                  <div class="flex flex-wrap -mx-3 mb-6">
                                    <div class="w-full px-3">
