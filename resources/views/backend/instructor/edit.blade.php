        ...
        <form action="{{route('instructor.update',$instructor->id)}}" method="post">
            ...
            >
              <label class="block text-sm">
                ...
                <input type="text" name="name" value="{{$instructor->name}}"class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
              ...
              <label class="block text- sm mt-4">
                ...
                <input type="date" id="datePicker"  name="dob" value="{{$instructor->dob}}"
              ...
              <label class="block mt-4 text-sm">
                ...
                <select name="gender" value="{{$instructor->gender}}"
              ...
              @error('gender')
                ...
                <input type="file" name="profile" value="{{$instructor->profile}}"
                  class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                  placeholder=""
                />
              </label>
              ...
              @error('address')
                ...
                @foreach(json_decode($instructor->link,true) as  $key => $link)
                  ...
                  <div class="w-full max-w-lg  border-2 relative mt-4 link_select" > 
                        ...
                        @if($key == 0)
                          <button  
                            class="addMore  px-3 py-1 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-purple-600 border border-transparent rounded-md active:bg-purple-600 hover:bg-purple-700 focus:outline-none focus:shadow-outline-purple"
                          >
                            Add more
                          </button>
                          @elseif($key <= count(json_decode($instructor->link,true)))
                          <button  class="delete_button px-3 py-1 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-red-600 border border-transparent rounded-md active:bg-red-600 hover:bg-red-700 focus:outline-none focus:shadow-outline-red">
                             Delete
                          </button>
                          @endif
                        </div>
