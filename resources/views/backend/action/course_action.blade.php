<div class="flex items-center space-x-4 text-sm">
                  ...
                  <a href="{{ route('episode.index' , [$course->id]) }}"
                         <button class="flex items-center justify-between px-2 py-2 text-sm font-medium leading-5 text-purple-600 rounded-lg dark:text-gray-400 focus:outline-none focus:shadow-outline-gray"aria-label="view">Episode</button>
                  </a>
</div>