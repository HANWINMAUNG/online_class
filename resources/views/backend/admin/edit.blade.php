             ...
             @csrf
                  <div class = "px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
                      ...
                      <label class = "block text- sm mt-4">
                          ...
                          <input type = "email" name = "email" value = "{{$admin->email}}" class = "block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" id = "email" />
                      </label>
                      @error('email')
                            <small style = "color:red;">{{ $message }}*</small>
                      @enderror
                      ...
                      <label class = "block mt-4 text-sm">
                        ...
                        <input type = "text" name = "phone" value = "{{ $admin->phone }}" class = "block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" />
                      </label>
                      @error('phone')
                                <small style = "color:red;">{{ $message }}*</small>
                      @enderror
                      ...
                      <label class = "block text- sm mt-4">
                        ...
                        <input type = "date" id = "datePicker"  name = "dob" value = "{{ $admin->dob }}" class = " w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" />
                      </label>
                      @error('dob')
                                <small style = "color:red;">{{ $message }}*</small>
                      @enderror
                      ...
                      <label class = "block mt-4 text-sm">
                            ...
                            <select name = "gender" value = "{{ $admin->gender }}" class = "block w-full mt-1 text-sm dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 form-select focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray">
                                  <option>Male</option>
                    ...
                    <div class=" rounded-md bg-white text-center">
                      ...
                      <label class = "block mt-4 text-sm">
                            ...
                            <textarea type = "text" name = "address" class = "block w-full mt-1 text-sm dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 form-textarea focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray" rows="3">{{ $admin->address }}</textarea>
                      </label>
                      @error('address')
                                <small style = "color:red;">{{ $message }}*</small>
                      @enderror
