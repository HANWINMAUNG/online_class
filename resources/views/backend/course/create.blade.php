    ...
    <div class="container px-6 mx-auto grid">
            ...
            <form action = "{{ route('course.store') }}" method = "post" id = "form" enctype = "multipart/form-data">
                  ...
                  <div class = "px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
                      ...
                      <label class = "block mt-4 text-sm">
                          <span class = "w-full text-gray-700 dark:text-gray-400"> Category Name<span style = "color:red;">*</span></span>
                      ...
                      <label class = "block mt-4 text-sm">
                            ...
                            <input type = "number" name = "price"class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"/>
                      </label>
                      @error('price')
                                <small style = "color:red;">{{ $message }}*</small>
                      @enderror
                      ...
                      <label class = "block mt-4 text-sm">
                          ...
                          <input type = "file" name = "cover_photo" class = "block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"/>
                      </label>
                      @error('cover_photo')
                                <small style = "color:red;">{{ $message }}*</small>
                      @enderror
                      ...
                      <label class = "block mt-4 text-sm">
                          ...
                          <textarea type = "text" name = "description" class = "block w-full mt-1 text-sm dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 form-textarea focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray"rows="3" id="description" ></textarea>
                      </label>
                      @error('description')
                                <small style = "color:red;">{{ $message }}*</small>
                      @enderror
                      ...
                      <label class="block mt-4 text-sm">
                          ...
                          <textarea  name="summary" id="inp_editor1" class="block w-full mt-1 text-sm dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 form-textarea focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray" rows="3"></textarea>
                      </label>
                      @error('summary')
                                <small style = "color:red;">{{ $message }}*</small>
                      @enderror
