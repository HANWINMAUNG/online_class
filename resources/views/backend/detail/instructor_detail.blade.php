               ...
               <div class="  mb-8 ">
                    <div class="w-full p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800">
                          ...
                          <div class="flex flex-row mt-4">
                                ...
                                <p class="ml-6 text-gray-600 dark:text-gray-400 basis-1/2 ">-{{ $instructor->email }}</p>
                          </div>
                          <div class="flex flex-row mt-4">
                            <p class="text-gray-600 dark:text-gray-400 basis-1/2 ml-8">Gender</p>
                            <p class="ml-6 text-gray-600 dark:text-gray-400 basis-1/2 ">-{{ $instructor->gender }}</p>
                          </div>
                          <div class="flex flex-row mt-4">
                            <p class="text-gray-600 dark:text-gray-400 basis-1/2 ml-8">Phone</p>
                            <p class="ml-6 text-gray-600 dark:text-gray-400 basis-1/2 ">-{{ $instructor->phone }}</p>
                          </div>
                          <div class="flex flex-row mt-4">
                            <p class="text-gray-600 dark:text-gray-400 basis-1/2 ml-8">Date of Birth</p>
                            <p class="ml-6 text-gray-600 dark:text-gray-400 basis-1/2 "> -{{ $instructor->dob }}</p>
                          </div>
                          <div class="flex flex-row mt-4">
                            <p class="text-gray-600 dark:text-gray-400 basis-1/2 ml-8">Joined Date</p>
                            <p class="ml-6 text-gray-600 dark:text-gray-400 basis-1/2 ">-{{ $instructor->created_at }}</p>
                          </div>
                          <div class="flex flex-row mt-4">
